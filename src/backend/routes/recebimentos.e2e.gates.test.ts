...
const buildFakeNdeRepo = (): { repo: AnyRecord; saves: AnyRecord[] } => {
    ...
    const repo: AnyRecord = {
        ...
        // A aba NDe do painel lê pela EXECUÇÃO (LEFT JOIN na NDe) — este harness não modela o join,
        // e o que estes cenários provam é a emissão, não a listagem. Vazio = painel sem aba NDe.
